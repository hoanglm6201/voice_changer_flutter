...
import 'package:voice_changer_flutter/view/screen/setting/widgets/feedback_item.dart';
      ...
      child: CupertinoAlertDialog(
        content: Column(
          children: [
            ...
            Text(context.locale.enjoy_app, style: const TextStyle(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 18),),
