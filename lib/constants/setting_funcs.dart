...
import 'package:voice_changer_flutter/view/widgets/dialog/rate_app_dialog.dart';
import 'package:voice_changer_flutter/view_model/app_setting_provider.dart';
...
class SettingFuncs {
  static void share() {
    SharePlus.instance.share(
      ShareParams(
        ...
        subject: 'Phone Cleaner: Cleaning',
      ),
    );
  }
  ...
  //             children: [
  //               Text(
  //                 context.locale.thank_you_for_rate_description,
  //                 style: const TextStyle(
  //                     color: Colors.black,
  //                     fontSize: 13,
          ...
          child: CupertinoAlertDialog(
            content: Column(
              children: [
                ...
                Text(
                  context.locale.thanks_for_your_feedback,
                  style: const TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.w600,
                      fontSize: 18),
                ...
                Text(
                  context.locale.thanks_for_your_feedback_description,
                  style: const TextStyle(
                      color: Colors.black,
                      fontSize: 13,
                      fontWeight: FontWeight.w400),
